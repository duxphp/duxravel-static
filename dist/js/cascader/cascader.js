...
(function () {
    ...
    var eo_cascader = function () {
        ...
        function EoCascader(data, config) {
            ...
            this.ele = config.elementID // DOM容器
        ...
        EoCascader.prototype.bindBodyClick = function bindCascaderClick(e) {
            ...
            this.ele.className = 'app-cascader dropdown'
        }
        ...
        EoCascader.prototype.bindCascaderClick = function bindCascaderClick(e) {
            ...
            this.ele.className = this.panelShowState ? 'app-cascader dropdown is-show' : 'app-cascader dropdown'
        }
        ...
        EoCascader.prototype.bindCascaderHover = function bindCascaderHover(e) {
            ...
            if (JSON.stringify(this.storageChecked) !== '{}') {
                this.ele.className = this.panelShowState ? 'app-cascader dropdown is-show is-clear' : 'app-cascader dropdown is-clear'
            }
        }
        ...
        EoCascader.prototype.initCheckedWrap = function initCheckedWrap() {
            ...
            checkedWrap.className = 'eo-checked-wrap form-select dropdown-toggle d-flex'
            checkedWrap.setAttribute('data-bs-toggle', "dropdown")
            return checkedWrap
        }
