(function ($, owner) {
    ...
    owner.loading = function (msg) {
        ...
        let $html = $(`<div id="app-loading" class="fixed z-50 inset-0 overflow-y-auto ease-in-out duration-300 opacity-0 pointer-events-none" style="display: none"><div class="flex items-center justify-center min-h-screen">
                    <div class="bg-black bg-opacity-60 rounded px-4 py-3 flex gap-2 items-center">
