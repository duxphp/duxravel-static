...
const Line = defineComponent({
  ...
  render() {
    const { tmNode } = this
    return <>
      {!tmNode.isFirstChild && <div className='n-tree-copy-line n-tree-copy-line-top'></div>}
      <Point tmNode={tmNode} />
      {!tmNode.isLastChild && <div className='n-tree-copy-line n-tree-copy-line-bottom'></div>}
    </>
  }
})
