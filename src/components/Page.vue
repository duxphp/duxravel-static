      ...
      <div class="flex-none">
        ...
        >
                <span class=" flex items-center justify-center">
                  <svg v-if="darkMode === 'light'" class="fill-current  text-gray-200" width="16" height="16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="white" fill-opacity="0.01"/><path d="M28.0527 4.41085C22.5828 5.83695 18.5455 10.8106 18.5455 16.7273C18.5455 23.7564 24.2436 29.4545 31.2727 29.4545C37.1894 29.4545 42.1631 25.4172 43.5891 19.9473C43.8585 21.256 44 22.6115 44 24C44 35.0457 35.0457 44 24 44C12.9543 44 4 35.0457 4 24C4 12.9543 12.9543 4 24 4C25.3885 4 26.744 4.14149 28.0527 4.41085Z" fill="none" stroke="#eee" stroke-width="4" stroke-linejoin="round"/></svg>
                  <svg v-if="darkMode === 'dark'" class="fill-current text-gray-200"  width="16" height="16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="white" fill-opacity="0.01"/><path fill-rule="evenodd" clip-rule="evenodd" d="M24 3V6.15V3Z" fill="#eee"/><path d="M24 3V6.15" stroke="#eee" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M38.8492 9.15076L36.6219 11.3781L38.8492 9.15076Z" fill="#eee"/><path d="M38.8492 9.15076L36.6219 11.3781" stroke="#eee" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M45 24H41.85H45Z" fill="#eee"/><path d="M45 24H41.85" stroke="#eee" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M38.8492 38.8492L36.6219 36.6219L38.8492 38.8492Z" fill="#eee"/><path d="M38.8492 38.8492L36.6219 36.6219" stroke="#eee" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M24 45V41.85V45Z" fill="#eee"/><path d="M24 45V41.85" stroke="#eee" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M9.15076 38.8492L11.3781 36.6219L9.15076 38.8492Z" fill="#eee"/><path d="M9.15076 38.8492L11.3781 36.6219" stroke="#eee" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3 24H6.15H3Z" fill="#eee"/><path d="M3 24H6.15" stroke="#eee" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M9.15076 9.15076L11.3781 11.3781L9.15076 9.15076Z" fill="#eee"/><path d="M9.15076 9.15076L11.3781 11.3781" stroke="#eee" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M24 36C30.6274 36 36 30.6274 36 24C36 17.3726 30.6274 12 24 12C17.3726 12 12 17.3726 12 24C12 30.6274 17.3726 36 24 36Z" fill="none" stroke="#eee" stroke-width="4" stroke-linejoin="round"/></svg>
...
export default {
  ...
  data() {
    return {
      ...
      userInfo: {},
      // 颜色模式
      darkMode: window.localStorage.getItem('darkMode') === 'dark' ? 'dark' : 'light'
    };
  },
  created() {
    // 监听路由改变
  ...
  methods: {
    ...
    // 切换颜色模式
    switchDark() {
      window.localStorage.setItem('darkMode', this.darkMode === 'dark' ? 'light' : 'dark')
